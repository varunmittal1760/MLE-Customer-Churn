...
def main(snapshotdate):
    ...
    print("\n--- STARTING GOLD LABEL STORE PROCESSING ---")
    print(f"\nProcessing Gold for Snapshot Date: {date_str}")
    utils.data_processing_gold_table.process_gold_label_store(date_str, base_silver_dir, base_gold_dir, spark)
    print("--- GOLD LABEL STORE COMPLETED ---")
