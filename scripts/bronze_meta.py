...
# to call this script: python bronze_meta.py --snapshotdate "2023-01-01"
...
def main(snapshotdate):
    ...
    utils.data_processing_bronze_table.process_bronze_meta(date_str, base_bronze_dir, spark)
